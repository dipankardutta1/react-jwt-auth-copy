...
import authService from '../../services/auth.service';
 ...
 class EditOrgComponent extends React.Component {
  ...
  componentDidMount() { // New Method added By Dipankar
    ...
    if (user && user.permissions.includes("EDIT_ORG")) {
...
handleValidity(e){
  ...
  render() {
    if(!this.state.showContent){
     ...
     return (
      <div>
        <Panel header="Edit Organization" >
    <div class="grid">
    <div class="col-11">
...
export default withRouter(EditOrgComponent);
